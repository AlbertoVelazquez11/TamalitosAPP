  ...
  container.innerHTML = `
    <div class="view">
      <div class="view-header">
        ...
        <h1 class="view-header__title">Administración de Productos</h1>
      </div>
      <div class="empty-state" style="margin-top: var(--space-8);">
        <div class="empty-state__icon">🚧</div>
        <p class="empty-state__title">Módulo en Construcción</p>
        <p class="empty-state__desc">El CRUD de productos se implementa en el Sprint 2.</p>
      </div>
    </div>`;
